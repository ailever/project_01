import argparse
from stylize_function import adaptive_instance_normalization
import stylize_network as net
...
def main():
    ...
    decoder.load_state_dict(torch.load('./images/stylized_coco/models/decoder.pth'))
    vgg.load_state_dict(torch.load('./images/stylized_coco/models/vgg_normalised.pth'))
