...
- <b>Language Models are Unsupervised Multitask Learners, [GPT, Transformer]</b> ｜[pdf](https://d4mucfpksywv.cloudfront.net/better-language-models/language_models_are_unsupervised_multitask_learners.pdf)
